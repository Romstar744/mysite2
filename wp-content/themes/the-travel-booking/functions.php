...
function the_travel_booking_enqueue_google_fonts() {
	...
	wp_enqueue_style( 'google-fonts-poppins', 'https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap' );
}
...
if (!function_exists('the_travel_booking_enqueue_scripts')) {
	...
	function the_travel_booking_enqueue_scripts() {
		...
		wp_add_inline_style( 'the-travel-booking-style', $the_travel_booking_css );
...
if (!function_exists('the_travel_booking_after_setup_theme')) {
	...
	function the_travel_booking_after_setup_theme() {
		...
		if ( ! isset( $the_travel_booking_css_content_width ) ) $the_travel_booking_css_content_width = 900;
...
function the_travel_booking_logo_resizer() {
    ...
    $the_travel_booking_theme_logo_size_css = '';
	...
	';
    wp_add_inline_style( 'the-travel-booking-style',$the_travel_booking_theme_logo_size_css );
...
function the_travel_booking_global_color() {
    ...
    $the_travel_booking_theme_color_css = '';
	...
	$the_travel_booking_theme_color_css = '
		...
		.sidebar-area h4.title{
			border-color: '.esc_attr($the_travel_booking_global_color_2).';
		}
	';
    wp_add_inline_style( 'the-travel-booking-style',$the_travel_booking_theme_color_css );
    wp_add_inline_style( 'the-travel-booking-woocommerce-css',$the_travel_booking_theme_color_css );
